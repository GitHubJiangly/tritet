...
fn main() -> Result<(), StrError> {
    ...
    let mut triangle = Triangle::new(26, Some(22), None, Some(3))?;
    ...
    // two dimples
    triangle
        .set_point(24, -50.0, 0.0)?
        .set_point(25, 50.0, 0.0)?;
    ...
    // two nostril segments
    triangle.set_segment(20, 20, 21)?.set_segment(21, 22, 23)?;
    ...
    triangle.draw_triangles(&mut plot, true, false, false, false, None, None, None);
